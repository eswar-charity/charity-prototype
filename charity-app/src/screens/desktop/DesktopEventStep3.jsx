  ...
  return (
    <DesktopCreateEventLayout step={3}>
      ...
      <button
        ...
        onClick={() => updateDraft({ location: 'Current location' })}
      >
      ...
      <div className={`vis-option ${draft.visibility === 'public' ? 'selected-vis' : ''}`} onClick={() => updateDraft({ visibility: 'public' })}>
      ...
      <div className={`vis-option ${draft.visibility === 'private' ? 'selected-vis' : ''}`} onClick={() => updateDraft({ visibility: 'private' })}>
      ...
      <div className="dsk-wizard-footer">
        <button className="dsk-wizard-back-link" onClick={() => navigate('/event/step-2')}>← Back</button>
        <button className="dsk-cta-btn" onClick={() => navigate('/event/step-4')}>Next: preview →</button>
      </div>
