  ...
  return (
    ...
    >
      ...
      <div className="adm-stats">
        <div className="adm-stat clickable warn" onClick={() => navigate('/admin/review')}>
        ...
        <div className="adm-stat clickable danger" onClick={() => navigate('/admin/exceptions')}>
        ...
        <div className="adm-stat clickable" onClick={() => navigate('/admin/events')}>
      ...
      <div className="adm-panel">
        ...
        {openExceptions.map((ex) => (
          <div key={ex.id} className="adm-item clickable" onClick={() => navigate('/admin/exceptions')}>
      ...
      <div className="adm-stats" style={{ marginBottom: 0 }}>
        <div className="adm-stat clickable" onClick={() => navigate('/admin/nonprofits')}>
        ...
        <div className="adm-stat clickable" onClick={() => navigate('/admin/audit')}>
        ...
        <div className="adm-stat clickable" onClick={() => navigate('/admin/review')}>
